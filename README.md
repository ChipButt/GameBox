...
- Six original long-form tracks with genuinely different course geometry; track-selection mini-maps are generated from the same paths used by rendering, rails, collisions and lap progress
